...
let teplotaFahrenheit = Number(prompt("Zadejte teplotu ve stupních Fahrenheita:"))

document.body.innerHTML += "<p>Tato teplota odpovídá " + Math.round(5/9 * (teplotaFahrenheit - 32)) + " °C.</p>"
